<x-clinic-layout :title="'Settings'">
    ...
    <div class="panel" style="margin-bottom: 1.5rem;">
        <h2 class="panel-title" style="margin-bottom: 1rem;">Appearance</h2>
   ...
   <!-- Exports -->
    <div class="panel" style="margin-bottom: 1.5rem;">
        <h2 class="panel-title" style="margin-bottom: 1rem;">Export Data</h2>
    ...
    @if (auth()->user()->isAdmin())
        ...
        <!-- User Management -->
        <div class="panel" style="margin-bottom: 1.5rem;">
            <h2 class="panel-title" style="margin-bottom: 1rem;">Staff Accounts</h2>
